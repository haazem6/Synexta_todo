...
class TodoController extends AbstractController
{
    ...
    public function create(Request $request)
    {
        ...
        $todo->setstartDate($content->start_date);
        $todo->setendDate($content->end_date);
        $todo->setPlace($content->place);
    ...
    public function update(Request $request, Todo $todo)
    {
        ...
        if ($todo->getTask() === $content->task && $todo->getDescription() === $content->description && $todo->getStartDate() === $content->start_date && $todo->getEndDate() === $content->end_date && $todo->getPlace() === $content->place) {
            return $this->json([
    ...
    /**
 * @Route("/find/{id}", name="api_todo_find", methods={"GET"})
 * @param int $id
 * @return JsonResponse
 */
public function find(int $id)
{
    ...
    if (!$todo) {
        return $this->json([
            'message' => ['text' => 'To-Do not found for the given ID.', 'level' => 'error']
        ]);
    }
    ...
    /**
 * @Route("/findbytask/{task}", name="api_todo_find", methods={"GET"})
 * @param int $task
 * @return JsonResponse
 */
public function findByTask(string $task)
{
    $todo = $this->todoRepository->find($task);
