    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('start_date', TextareaType::class, [
                'constraints' => [
                    new NotBlank(['message' => 'The start_date cannot be blank!']),
                    new Length([
                        'min' => 1,
                        'max' => 500,
            ...
            ->add('end_date', TextareaType::class, [
                'constraints' => [
                    new NotBlank(['message' => 'The end_date cannot be blank!']),
                    new Length([
                        'min' => 1,
                        'max' => 500,
            ...
            ->add('place', TextareaType::class, [
                'constraints' => [
                    new NotBlank(['message' => 'The place cannot be blank!']),
                    new Length([
                        'min' => 1,
                        'max' => 500,
